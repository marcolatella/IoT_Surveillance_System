...
void loop() {
   ...
   */
  if ((millis() - weather_t > 1800000) && armed && !alarmed){
    currentWeather();
    if(bot_activated){
...
void currentWeather() {
  ...
  new_weather = doc["weather"][0]["main"].as<String>();           //TODO Da decommentare
  //new_weather = "Thunderstorm";                                     //TODO Da rimuovere
